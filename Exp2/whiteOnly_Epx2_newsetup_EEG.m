...
try
    ...
    %====== initial condition =====% 
        initialThr = [0.5 0.5 0.5 0.5 0.5 0.5];
            ...
            % -------hint for progress & taking break-------%
             ...
             if mod(i,70) == 1 && i~= 1
                 while 1
                    ...
                    if i== 71, Writetext(wPtr,'20% done',L_cenX, R_cenX,BoxcenY, 120,100, [255 255 255],30); end
                    if i== 141, Writetext(wPtr,'40% done',L_cenX, R_cenX,BoxcenY, 120,100, [255 255 255],30); end
                    if i== 211, Writetext(wPtr,'60% done',L_cenX, R_cenX,BoxcenY, 120,100, [255 255 255],30); end
                    if i== 281, Writetext(wPtr,'80% done',L_cenX, R_cenX,BoxcenY, 120,100, [255 255 255],30); end
